...
namespace P05PasekLadowania
{
    ...
    partial void InsertHistoriaTemperatury(HistoriaTemperatury instance);
    partial void UpdateHistoriaTemperatury(HistoriaTemperatury instance);
    partial void DeleteHistoriaTemperatury(HistoriaTemperatury instance);
    #endregion
		
		public ModelBazyDanychDataContext() : 
				base(global::P05PasekLadowania.Properties.Settings.Default.A_ZawodnicyConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<HistoriaTemperatury> HistoriaTemperatury
		{
			get
			{
				return this.GetTable<HistoriaTemperatury>();
			}
		}
	}
    ...
    partial void OnmiastoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_miasto", DbType="VarChar(255)")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.historiaTemperatury")]
	public partial class HistoriaTemperatury : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _nazwaMiasta;
		
		private System.Nullable<System.DateTime> _dataSprawdzenia;
		
		private System.Nullable<int> _temperatura;
    ...
    partial void OnnazwaMiastaChanging(string value);
    partial void OnnazwaMiastaChanged();
    partial void OndataSprawdzeniaChanging(System.Nullable<System.DateTime> value);
    partial void OndataSprawdzeniaChanged();
    partial void OntemperaturaChanging(System.Nullable<int> value);
    partial void OntemperaturaChanged();
    #endregion
		
		public HistoriaTemperatury()
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nazwaMiasta", DbType="VarChar(255)")]
		public string nazwaMiasta
		{
			get
			{
				return this._nazwaMiasta;
			}
			set
			{
				if ((this._nazwaMiasta != value))
				{
					this.OnnazwaMiastaChanging(value);
					this.SendPropertyChanging();
					this._nazwaMiasta = value;
					this.SendPropertyChanged("nazwaMiasta");
					this.OnnazwaMiastaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dataSprawdzenia", DbType="DateTime2")]
		public System.Nullable<System.DateTime> dataSprawdzenia
		{
			get
			{
				return this._dataSprawdzenia;
			}
			set
			{
				if ((this._dataSprawdzenia != value))
				{
					this.OndataSprawdzeniaChanging(value);
					this.SendPropertyChanging();
					this._dataSprawdzenia = value;
					this.SendPropertyChanged("dataSprawdzenia");
					this.OndataSprawdzeniaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_temperatura", DbType="Int")]
